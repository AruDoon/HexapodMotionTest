...
int main() {
    ...
    while (true) { // Loop agar menunggu input terus-menerus
        std::cin.get(); // Menunggu Enter ditekan
        coba_majuv2(); // Panggil fungsi setelah Enter ditekan
        std::cout << "Tekan Enter lagi untuk menjalankan coba_majuv2()..." << std::endl;
    }
...
void siap()
{
    ...
    trj_start(kR1, kR2, kR3, kL1, kL2, kL3, ultra_slow, 3000);
}

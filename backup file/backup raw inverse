...
#include <cstdint>
#include <cmath>
#include <unistd.h>  // Required for sleep() in Linux
...
//offset bodi (mm)
//kaki L1
float offset_L1_x = 36.25;
float offset_L1_y = -62.79;
float offset_L1_z = 0;
//kaki L2
float offset_L2_x = 72.5;
float offset_L2_y = 0;
float offset_L2_z = 0;
//kaki L3
float offset_L3_x = 36.25;
float offset_L3_y = -62.79;
float offset_L3_z = 0;
//kaki R1
float offset_R1_x = 36.25;
float offset_R1_y = -62.79;
float offset_R1_z = 0;
//kaki R2
float offset_R2_x = 72.5;
float offset_R2_y = 0;
float offset_R2_z = 0;
//kaki R3
float offset_R3_x = 36.25;
float offset_R3_y = -62.79;
float offset_R3_z = 0;
...
unsigned long interval = 1; // interval waktu dalam milidetik
//Define Variables we'll be connecting to
float setpoint, error, delta_error, P, I, D, nilai_sensor,
      hasil_PID, error_sebelumnya;
//Specify the links and initial tuning parameters
float Kp = 0.2, Ki = 12, Kd = 0, T = 0.01;
